...
function mm_render_snapshot($file){
  ...
  $font_fix='<style id="mm-vietnamese-font-fix">'
    ...
    .'@font-face{font-family:MiSansLight;src:url("'.$asset.'/s/manrope/v20/xn7_YHE41ni1AdIRqAuZuw1Bx9mbZk79FO_F.ttf") format("truetype");font-style:normal;font-weight:400;font-display:swap}'
    .'@font-face{font-family:MiSans;src:url("'.$asset.'/s/manrope/v20/xn7_YHE41ni1AdIRqAuZuw1Bx9mbZk79FO_F.ttf") format("truetype");font-style:normal;font-weight:400;font-display:swap}'
  ...
  $support_footer=<<<'HTML'
<section class="mm-site-footer" aria-label="Hệ thống hỗ trợ & Thông tin liên hệ">
  ...
  <div class="mm-site-footer__grid">
    <article class="mm-site-footer__card">
      ...
      <p class="mm-site-footer__address"><span aria-hidden="true">⌖</span> Số 8, Đường Tôn Thất Thuyết, Phường Mỹ Đình 2, Nam Từ Liêm, Hà Nội</p>
    ...
    <article class="mm-site-footer__card">
      ...
      <p class="mm-site-footer__address"><span aria-hidden="true">⚡</span> Hỗ trợ và tư vấn khách hàng mọi lúc, mọi nơi</p>
      <a class="mm-site-footer__phone" href="tel:1900638400"><span aria-hidden="true">☎</span> 1900.63.8400</a>
    </article></div>
